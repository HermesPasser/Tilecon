...
namespace tilecon.Tileset.Converter.Tests
{
    ...
    public class TilesetConverterVXTests : TilesetTestBase
    {
        ...
        {
            converter = new TilesetConverterVX(Tileset.VX_Ace_A3, SpriteMode.ALIGN_TOP_LEFT, false);
        ...
        {
            converter = new TilesetConverterVX(Tileset.VX_Ace_A4, SpriteMode.ALIGN_TOP_LEFT, false);
        ...
        {
            converter = new TilesetConverterVX(Tileset.VX_Ace_A5, SpriteMode.ALIGN_TOP_LEFT, false);
        ...
        {
            converter = new TilesetConverterVX(Tileset.VX_Ace_BE, SpriteMode.ALIGN_TOP_LEFT, false);
