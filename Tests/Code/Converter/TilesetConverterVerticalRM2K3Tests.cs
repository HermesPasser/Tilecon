...
namespace tilecon.Tileset.Converter.Tests
{
    ...
    public class TilesetConverterVerticalRM2K3Tests : TilesetTestBase
    {
        ...
        {
            converter = new TilesetConverterVerticalRM2K3(Core.Tileset.R2k_2k3_Auto, SpriteMode.ALIGN_TOP_LEFT, false);
        ...
        {
            converter = new TilesetConverterVerticalRM2K3(Core.Tileset.R2k_2k3_AnimObj, SpriteMode.ALIGN_TOP_LEFT, false);
            Bitmap converted = converter.ConvertToMV(BitmapFromResourceStream("Tests.Images.R2k.R2k3_in.png"))[0];
        ...
        {
            converter = new TilesetConverterVerticalRM2K3(Core.Tileset.R2k_2k3_AB, SpriteMode.ALIGN_TOP_LEFT, false);
        ...
        {
            converter = new TilesetConverterVerticalRM2K3(Core.Tileset.R2k_2k3_A, SpriteMode.ALIGN_TOP_LEFT, false);
            Bitmap converted = converter.ConvertToMV(BitmapFromResourceStream("Tests.Images.R2k.R2k3_in.png"))[0];
        ...
        {
            converter = new TilesetConverterVerticalRM2K3(Core.Tileset.R2k_2k3_B, SpriteMode.ALIGN_TOP_LEFT, false);
            Bitmap converted = converter.ConvertToMV(BitmapFromResourceStream("Tests.Images.R2k.R2k3_in.png"))[0];
